...
<body>
    <div id="full">
        ...
        <div id="banner">
            ...
            <div>
            <h1 align="center"><font color="blue" size="30">Users</font></h1>
                <center>
                
                <table>
                    <tr>
                        <th width="10%" height="50%">Username</th>
                        <th width="10%" height="50%">Full Name</th>
                        <th width="10%" height="50%">Email</th>
                        <th width="10%" height="50%">Contact No</th>
                    </tr>
                    <?php 
                        ...
                        $sql = "SELECT username, full_name, email, contact FROM user_details";
                        $result = mysqli_query($db, $sql);
                        if(mysqli_num_rows($result) > 0){
				
                            while($row = mysqli_fetch_array($result)){
                                echo "<tr><td><center>" . $row["username"] . "</center></td><td><center>". $row["full_name"] . "</center></td><td><center>". $row["email"] . "</center></td><td><center>". $row["contact"] . "</center></td></tr>";
                            }
                        }
        ...
        <div id="banner">
            ...
            <div>
            <h1 align="center"><font color="blue" size="30">Booked Properties</font></h1>
                <center>
                
                <table>
                    <tr>
                        <th width="10%" height="50%">Booked By</th>
                        <th width="10%" height="50%">Apartment Name</th>
                        <th width="10%" height="50%">Number of Flat</th>
                    ...
                    <?php 
                        ...
                        $sql = "SELECT booked_by, ap_name, num_flat FROM booking_confrim";
                        $result = mysqli_query($db, $sql);
                        if(mysqli_num_rows($result) > 0){
				
                            while($row = mysqli_fetch_array($result)){
                                echo "<tr><td><center>" . $row["booked_by"] . "</center></td><td><center>". $row["ap_name"] . "</center></td><td><center>". $row["num_flat"] . "</center></td></tr>";
                            }
                        }
